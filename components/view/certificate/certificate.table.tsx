...
import { ICertificateList, ICertificates } from "@models/certificate"
...
export default function CertificateTable({certificates, total}: ICertificateList) {
    ...
    if (session) {
        return (
            <div>
                <DataTable<ICertificates>
                    editAction={userProfile?.role === 'admin'}
                    total={total}
                    endpoint="/certificates"
                    items={certificates}
                    onCreate={handleCreate}
                    actionOptions={(item: ICertificates) => (
