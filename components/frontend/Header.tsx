...
function MobileNavLink({href, children}: propHeader) {
    return (
...
interface propMobileNavIcon {
    open: boolean
}

function MobileNavIcon({open}: propMobileNavIcon) {
    return (
        <svg
            aria-hidden="true"
            ...
            <Transition.Root>
                ...
                >
                    ...
                    >
                        ...
                        <MobileNavLink href="#contact-us">ContactUs</MobileNavLink>
