...
interface typeBaseStyles {
  [key: string]: any;
  solid: string,
  outline: string
}
const baseStyles: typeBaseStyles = {
  solid:
...
const variantStyles: typeVariantStyles = {
  solid: {
...
export function Button({variant = 'solid', color = 'slate', className, href, ...props}: propButton) {
  className = clsx(
    baseStyles[variant],
