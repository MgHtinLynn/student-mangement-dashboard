...
import screenshotProfitLoss from '@components/images/screenshots/profit-loss.png'

const features: ({ summary: string; image: any; name: string; icon: () => JSX.Element; description: string })[] = [
  {
    name: 'Reporting',
...
function Feature({ feature, isActive, className, ...props }: propFeature) {
  return (
    <div
